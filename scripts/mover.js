let mover = {
    ...
    /**
     * В зависимости от того какую стрелку нажал пользователь метод
     * возвращает координаты новой ячейки, либо если туда нельзя сделать шаг, то
     * координаты существующей ячейки.
     * @param {KeyboardEvent} event объект события нажатия клавиши
     ...
     * @param {{x: number, y: number}} newPos yjdfz gjpbwbz
